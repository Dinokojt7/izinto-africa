  ...
  return (
    <div className = 'flex justify-between items-center mt-5 max-w-[1240] mx-auto px-4 font-semibold text-black'>
        ...
        <div className={!nav ? 'fixed left-0 top-0 h-full w-[30%] border-r border-r-gray-100 bg-[#ffffff]' : 'fixed left-[-100%] top-0 h-full w-[30%] border-r border-r-gray-100 bg-[#ffffff]'}>
          ...
          <ul className=' '>
          <a href="#"><li className='pl-4 pt-2 pb-2 hover:bg-[#f5f5f5] ' onMouseEnter={handleSubList} onMouse onMouseLeave={handleSubList}>Departments</li></a>
          <a href="#"> <li className='pl-4 pt-2 pb-2 hover:bg-[#f5f5f5]'>Help</li></a>
          </ul>
        </div>
        <div className={!list ? 'fixed left-[30%] top-0 h-full w-[30%] border-r border-r-gray-100 bg-[#ffffff] ' : 'fixed left-[-100%] top-0 h-full w-[30%] border-r border-r-gray-100 bg-[#ffffff]'}>
          <ul className=' 'onMouseEnter={handleSubList}>
            <a href="#"><li className='pl-4 pt-2 pb-2 hover:bg-[#f5f5f5] ' onClick={handleSubList}>Departments</li></a>
            <a href="#"> <li className='pl-4 pt-2 pb-2 hover:bg-[#f5f5f5]'>Help</li></a>
          </ul>
        </div>
